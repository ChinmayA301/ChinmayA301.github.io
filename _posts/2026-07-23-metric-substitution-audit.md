---
layout: post
title: "Successful India™"
date: 2026-07-23
author: "Chinmay Arora"

description: "A data essay about a country winning at everything except the things that compound—and a companion 27-state study testing whether enrollment still carries information about foundational learning."
summary: "India has become extraordinarily good at producing numbers that look like success, and extraordinarily reluctant to measure the things that actually compound: learning, wages, retained talent, research, and institutional accountability."
tags: [india, metric-substitution, education, public-policy, political-economy, research, data-science, governance]
categories: [Data Science, Public Policy, Research]
content_type: "research_study"
content_label: "Data Essay + Companion Study"
reading_time: "22 min read"
search_phrase: "Successful India metric substitution proxy gap"
positioning_note: "The essay is the study. Its final section operationalizes the education claim on a reproducible 27-state ASER panel; the audit and dashboard are companion evidence."
...
And we are. That part is true and worth saying without a sneer: real GDP has run at roughly 6.4–7.6% across FY24–FY26, nominal GDP has crossed $3.9 trillion, and GST collections touched about ₹19.35 lakh crore in FY25–26.[^ibef] India genuinely is the fastest-growing major economy. Hold that thought, because everything that follows is not a denial of it — it is a question about *who is in the photograph.*

Here is the thing the headline number cannot see: the median Indian's wage.

Economists Arindam Das and Jean Drèze, using the Labour Bureau's own *Wage Rates in Rural India* series, found that real rural wages grew nearly 7% a year between 2010-11 and 2015-16 — and then collapsed to roughly zero.[^wages] Nominal agricultural wages rose about 6% a year from 2014 to 2024; adjusted for inflation, that becomes about 1%. Over the same decade, per-capita income grew about 4.6% in real terms.[^wages] So the economy nearly quintupled the pace at which it created *output* relative to the pace at which it paid the person doing the work.

Meanwhile, at the top: corporate profits at India's largest listed companies rose 22.3% in FY24, while employment at those same companies grew 1.5%.[^profits] The profit-to-GDP ratio for the Nifty 500 hit 4.8% — the highest since FY08, the year before the global financial crisis.[^profits]

This is what economists at Ashoka University's CEDA and the *World Inequality Report 2026* call a K-shaped economy: two lines leaving the same point, one going up, one going flat, both technically part of "the recovery."[^kshaped] The aggregate is real. The distribution is the story. GDP is a photograph taken from far enough away that everyone looks like they're smiling.

**The honest caveat:** jobless growth is not a Modi-era invention. The term itself describes India since the 1991 liberalisation — employment elasticity has been falling for thirty years as growth concentrated in capital-intensive services that don't hire at scale.[^jobless] This government inherited the pattern. What it did was perfect the *marketing* of the aggregate while the wage line went flat underneath it.
...
We have near-universal enrolment — about 98% for the 6-14 age group, and it's been above 95% for nearly two decades.[^aser2] We built that, and it is a genuine achievement. But enrolment measures whether a child is *in the building.* It says nothing about whether learning is happening inside it. And here's the tell: enrolment is now so uniformly high across states that it has stopped distinguishing good school systems from bad ones — it carries almost no information — while the learning numbers vary enormously. We optimised the metric we could photograph — bums on seats — and declared the mission accomplished, because "enrolment" is the number that goes in the brochure. (This isn't just rhetoric; it's measurable, and the companion study quantifies exactly how saturated the proxy has become.)

**The honest caveat, twice over:** First, ASER 2024 is not all bleak — it recorded the biggest improvement in the report's 20-year history, driven by government schools and the NEP 2020 foundational-literacy push.[^aser3] Real, ground-level, worth crediting. Second — and this cuts the other way — India's own government learning survey, the NAS, is statistically unreliable even for comparing states, per peer-reviewed work by Johnson and Parrado.[^nas] So when the official machinery reports its own progress, treat it the way you'd treat a student grading their own exam.

Then the assembly line moves the under-read child forward anyway, and eventually hands them a degree.

- **80%** of Indian engineering graduates were rated unemployable in the widely-cited Aspiring Minds employability work.[^engineers]
- **83%** of 2024 engineering graduates remained without a job or internship, per the Unstop Talent Report 2025 — even as the India Skills Report rated 71.5% of them "job-ready."[^unstop]
- Fewer than **7%** of male graduates secured a permanent salaried job within a year of graduating in 2023, per Azim Premji University's *State of Working India 2026.*[^swi]
...
A peer-reviewed study in the *Journal of Development Economics* (Ganguli et al., also an NBER paper) tracked IIT entrance-exam scorers. Among the top 1,000 JEE scorers, about 36% migrate abroad. Among the top 100, it's **62%.** Among the top 10 — nine out of ten.[^iit] Migration doesn't just rise with education; it rises with *ability.* The better you are, the more likely India loses you.

It's not only students. Roughly a third of newly-qualified MBBS physicians emigrate annually, concentrated among the top colleges.[^docs] India has about 3.12 million highly-educated migrants across the OECD — the largest such stock of any country, ahead of China.[^oecd] Student outflow went from 7.5 lakh in 2022 to 13.3 lakh in 2024, per the External Affairs Minister's own reply in the Lok Sabha.[^students]

And the money leaves with the minds. Per Henley & Partners, India lost about 5,100 dollar-millionaires in 2023 and a projected ~3,500 in 2025, taking roughly $26 billion with them.[^hnwi] (Honest caveat: that annual number is *falling*, and India's ultra-wealthy population is still growing off a rising base per Knight Frank — so this is a leak, not a haemorrhage.[^hnwi2])

The drivers are not mysterious and they are not primarily about patriotism. IIT starting salaries of ₹20–30 lakh versus $150k+ for the equivalent Silicon Valley role. Quality of life — pollution, infrastructure, safety, an HDI rank near 134th. Tax and regulatory friction versus the UAE's zero-income-tax golden visa. And, tellingly, the education of *their own children* — the wealthy leave partly so their kids can access the schooling this essay's Section II describes.[^drivers] The people best positioned to judge the Indian system are voting against it with their feet, and taking their capital and their children with them.
...
On the Stanford 2025 Global AI Vibrancy index, the United States scores 78.6, China 36.95, and India 21.59.[^aiindex] India ranks roughly third overall — a real, creditable position driven by talent and adoption — but the gap to the top two is an *order of magnitude*, and India has no home-grown frontier model in the league of OpenAI, DeepMind, Anthropic, or DeepSeek. Sovereign compute under the IndiaAI Mission reached about 38,000 GPUs in mid-2025, targeting 100,000 public GPUs by end-2026.[^compute] For scale: a single US frontier cluster is 100,000+ GPUs, and xAI is targeting a million.[^compute2] India was at near-zero sovereign compute until 2024.

Now the punchline. Per the National Foundation for American Policy (2026), India is the **#1 country of origin for immigrant founders of US unicorns — 96 companies**, ahead of Israel (60), the UK (47), and China (41).[^nfap] In AI specifically, the Institute for Progress found 60% of top US AI companies have at least one immigrant founder, and among them **India leads with nine founders**, ahead of China's eight.[^ifp] Perplexity's Aravind Srinivas is the flagship. And 70%+ of these immigrant AI founders first arrived in America on a *student visa.*[^ifp]
...
India's Gross Expenditure on R&D has been stuck at about **0.64% of GDP** — per the Economic Survey 2025-26 — versus China's 2.4%, the US's 3.5%, South Korea's 4.9%, Israel's 5.6%, and a world average near 1.8%.[^rd] The damning framing is not that it's low. It's that it *fell* — from about 0.90% in 2008.[^rd2] As GDP grew, the share we bet on the future shrank.

The gap is private-sector: Indian business funds about 36% of R&D, versus 75–79% in the US, China, and Korea.[^rd3] The Chief Economic Adviser's own diagnosis, citing Lazonick's work on financialisation, is blunt — Indian corporates learned to do American-style buybacks and dividends *before* they built manufacturing and research depth. Premature financialisation: we financialised the economy before we industrialised the knowledge base.[^fin]

And the human cost lands right back on Section III: India has 262 researchers per million people, versus South Korea's 8,714.[^rd4] We produce ~40,000 PhDs a year and have ~85,000 researchers working abroad.[^rd4]

**The honest caveat:** the government has responded — the Anusandhan National Research Foundation (ANRF), a ~$10 billion, five-year vehicle, and a ₹1 lakh crore RDI fund.[^anrf] Real policy. But here's the reality check that punctures the press release: of the previous year's RDI allocation, only about **15% was actually spent.**[^util] The problem isn't only that we don't allocate. It's that we can't deploy what we do allocate. You cannot fix a research culture with a fund you don't disburse.

---

## VI. Where the money in the room actually comes from

You'll notice this essay has been careful. It credits UPI (genuinely world-leading real-time payment volume), BHASHINI (hundreds of millions of inferences a month across 22 languages), ISRO, and India's rise to third-largest producer of scholarly publications.[^good] These are real, ground-level, *built* things — not press releases. Give credit where output exists.
...
**The Electoral Bonds scheme.** On 15 February 2024, a unanimous five-judge Constitution Bench of the Supreme Court struck down the electoral bonds scheme — introduced by this government in 2017 — as *unconstitutional*, holding that anonymous corporate political funding violated voters' right to information under Article 19(1)(a).[^bonds] The court ordered the data disclosed. When it was, the numbers were these: at its peak the scheme accounted for about 56% of all political funding in the country;[^bonds2] the BJP received about 48% of all bond donations across 20 major parties, and by one ADR analysis nearly **90% of corporate bond donations**, from a scheme worth roughly ₹16,518 crore.[^bonds3] The court explicitly warned the design could enable "quid pro quo."[^bonds4] This is not an op-ed. It is a judgment.

**The enforcement asymmetry.** Part of this is entirely self-documenting, because it comes from the government's replies to its own Parliament. The Enforcement Directorate registered 193 cases against politicians over ten years and secured convictions in **two.**[^ed] Across all PMLA cases, the conviction rate since 2019 is under 5% — 42 of 911 cases.[^ed2] Those are the state's own numbers. What the state pointedly does *not* publish is the party-wise breakdown: the Ministry of Finance told Parliament it keeps no record of whether the accused were ruling-party or opposition. That gap is filled by others — an *Indian Express* investigation and a plea by 14 opposition parties to the Supreme Court, which found the share of ED and CBI cases targeting opposition politicians rose from about 54% before 2014 to roughly **95% after.**[^ed3] Treat those two things at their true weight: the near-total non-conviction is government data; the 95%-opposition figure is journalism and litigation, not a government admission — though the government's refusal to release the breakdown that would confirm or refute it is telling in its own right. What both point to is an agency that almost never convicts, where the PMLA's near-impossible bail provisions mean the *process* is the punishment, regardless of the verdict that rarely comes.

**The institutional scoreboard.** V-Dem reclassified India from a liberal democracy (2014) to an "electoral autocracy" (by 2020) and records about a 20% decline in judicial-autonomy indicators over 2014-2024.[^vdem] Freedom House downgraded India from "Free" to "Partly Free" in 2021.[^fh] RSF's press-freedom rank fell from 150 to 161 of 180.[^rsf] The *Journal of Democracy*'s scholarly framing is the sharpest: the legal *right* to dissent remains on the books while the practical possibility of dissent free from harassment has, in their words, largely disappeared.[^jod]
...
![ASER 2024 scatter plot comparing rural enrolment and Class 3 reading across 27 states and union territories](/assets/blog/metric-substitution-audit/aser-access-vs-learning.png)
...
<div class="research-dashboard-shell">
  <div class="research-dashboard-toolbar">
    <p><strong>Successful India™ · companion data lab</strong><br><span>Explore the 27-state panel, inspect each state, change denominators, and download the source tables.</span></p>
  ...
  <iframe
    ...
    title="Successful India companion data-science dashboard"
    loading="lazy"
    allow="fullscreen"
    allowfullscreen
  ></iframe>
...
The [complete research package](https://github.com/ChinmayA301/blog-artifacts/tree/codex/metric-substitution-audit/successful-india) keeps the original essay, dashboard, 43-claim source tracker, exploratory study scripts, methods, extracted CSVs, full-panel analysis, results, and figures together.
...
[^ibef]: India Brand Equity Foundation, Economic Survey / MoSPI GDP and GST figures, FY25–26.
[^wages]: Das & Drèze, Labour Bureau *Wage Rates in Rural India* series; summarised in "The Long Stagnation of Indian Wages," Countercurrents, 2026.
[^profits]: SBI / Nifty 500 profit-to-GDP analysis, FY24; reported via The Federal year-end economy review 2025.
[^kshaped]: CEDA, Ashoka University, "The Indian GDP Trajectory: U, V, W or K-shaped?"; World Inequality Report 2026.
[^jobless]: Employment-elasticity decline post-1991; PLFS and Economic Survey data; Vajiram/Drishti IAS jobless-growth analyses.
[^aser]: ASER 2024 National Findings, ASER Centre / Pratham. Note: 23.4% (Class 3 reading), 44.8% (Class 5 reading) and 30.7% (Class 5 division) are government-school figures as stated in the report; 27.1% (Class 3 reading, all schools) and 33.7% (Class 3 subtraction, all-India) are the all-children figures. Labelled accordingly above.
[^aser2]: UDISE+, Ministry of Education, enrolment and infrastructure data.
[^aser3]: ASER 2024; NEP 2020 Foundational Literacy and Numeracy (NIPUN Bharat) implementation data.
[^nas]: Johnson & Parrado (2021), "Assessing the assessments," on NAS/ASER reliability (PMC8246517).
[^engineers]: Aspiring Minds National Employability Report; widely cited ~80% figure.
[^unstop]: Unstop Talent Report 2025; India Skills Report 2025 (Wheebox/AICTE/AIU/CII).
[^swi]: State of Working India 2026, Azim Premji University.
[^iit]: Ganguli et al., "Top Talent, Elite Colleges, and Migration: Evidence from the IITs," Journal of Development Economics / NBER.
[^docs]: MBBS emigration estimates; MEA Lok Sabha replies; Deccan Herald "Stop the Talent Drain."
[^oecd]: OECD International Migration Database; highly-educated migrant stock.
[^students]: MEA reply, Lok Sabha Q.894; World Bank "India's Great Student Out-Migration."
[^hnwi]: Henley Private Wealth Migration Report 2023–2025.
[^hnwi2]: Knight Frank Wealth Report; CNBC "Inside India" HNWI survey.
[^drivers]: Compiled HNWI migration surveys; TerraTern, CNBC, Business Standard.
[^aiindex]: Stanford 2025 Global AI Vibrancy Tool.
[^compute]: IndiaAI Mission GPU deployment figures, 2025; WION, Education for All in India.
[^compute2]: ORF, "India in the AI Race: Why Compute Will Decide Power."
[^nfap]: NFAP (Stuart Anderson), "Immigrants and US Billion-Dollar Companies," 2026.
[^ifp]: Institute for Progress, analysis of Forbes AI 50 (2025); CSET/Georgetown on student-visa origin.
[^density]: Stanford VC Initiative (Strebulaev), immigrant unicorn-founder analysis.
[^rd]: Economic Survey 2025-26 on GERD; Forbes India, Business Today.
[^rd2]: GERD decline from ~0.90% (2008) to 0.64%; SabrangIndia/NewsClick; arXiv 2411.15045.
[^rd3]: Economic Survey on private-sector R&D share.
[^fin]: CEA citing Lazonick (HBR) on financialisation; Plutus IAS.
[^rd4]: Asia Times, "India's R&D crisis isn't a money problem," on researcher density and diaspora.
[^anrf]: ANRF Act 2023; Union Budget 2026-27 RDI fund allocation.
[^util]: RDI fund utilisation (~15% of prior allocation); Plutus IAS / Budget 2026-27 coverage.
[^good]: UPI/NPCI volume data; BHASHINI inference figures; Economic Survey publication rankings.
[^bonds]: Association for Democratic Reforms v. Union of India, judgment 15 Feb 2024; Article 19(1)(a).
[^bonds2]: Stimson Center, "India's Electoral Bond Conundrum," on 56% of political funding.
[^bonds3]: ADR analysis; ECI-disclosed data; BJP ~48% of bonds / ~90% of corporate bond donations; ~₹16,518 cr encashed.
[^bonds4]: SC Constitution Bench, "quid pro quo" warning, 15 Feb 2024.
[^ed]: Ministry of Finance reply, Rajya Sabha, 2025: 193 cases, 2 convictions.
[^ed2]: The Wire, on <5% PMLA conviction rate since 2019 (42 of 911); govt reply to Randeep Surjewala.
[^ed3]: Indian Express investigation; 14-opposition-party SC plea; opposition share 54%→95% post-2014.
[^vdem]: V-Dem Democracy Report 2025; electoral-autocracy reclassification; judicial-autonomy decline.
[^fh]: Freedom House, Freedom in the World, "Free"→"Partly Free," 2021.
[^rsf]: RSF World Press Freedom Index, rank 150→161.
[^jod]: Journal of Democracy, "Why India's Democracy Is Dying," 2024.
