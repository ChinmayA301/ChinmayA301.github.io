---
layout: post
title: "Project Restub: Turning Cigarette Waste into Bricks Through Social Entrepreneurship"
date: 2026-05-19
author: "Chinmay Arora"

description: "A reflection on Project Restub, an Enactus SRM initiative I brainstormed and led during undergrad, focused on converting cigarette butt waste into usable bricks with local brick workers."
summary: "Project Restub was an Enactus SRM social entrepreneurship project that explored converting cigarette butt waste into brick-making material through collaboration with local brick workers. Alongside FlyLife, a drone-aided local medicine delivery concept during COVID, and an Enactus marketplace for Enactus India products, this project shaped my early approach to sustainability, product thinking, community-centered design, and practical implementation."

categories: [Social-Entrepreneurship, Sustainability, Undergraduate-Projects, Product-Design]
tags: [Enactus, Enactus-SRM, Project-Restub, Sustainability, Circular-Economy, Cigarette-Waste, Brick-Making, Social-Impact, FlyLife, Drone-Delivery, COVID-Response, E-Commerce]

permalink: /blog/project-restub-enactus-social-entrepreneurship/
canonical_url: "https://app.chinmayarora.com/blog/project-restub-enactus-social-entrepreneurship/"
...
```mermaid
flowchart LR
    A[Cigarette Butt Waste] --> B[Collection]
    B --> C[Sorting and Processing]
    C --> D[Brick-Making Input]
    D --> E[Local Brick Workers]
    E --> F[Usable Bricks]
    F --> G[Local Construction or Sale]
    G --> H[Environmental and Economic Impact]
```
...
```mermaid
flowchart TD
    A[Messy Real-World Problem] --> B[Stakeholder Understanding]
    B --> C[System Mapping]
    C --> D[Prototype or Intervention]
    D --> E[Testing and Feedback]
    E --> F[Measurement]
    F --> G[Iteration]
    G --> H[Scalable Operating Model]
```
