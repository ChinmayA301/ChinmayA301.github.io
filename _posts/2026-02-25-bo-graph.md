...
date: 2026-02-25
description: "An exploration of Bayesian optimization on graphs, explaining how graph structure, combinatorial search spaces, surrogate models, and acquisition choices shape practical optimization."
...
# SEO: Meta Tags
og_image: "/assets/blog/idea_desc.png"
canonical_url: "https://app.chinmayarora.com/blog/bo-graph/"
content_type: "concept_note"
content_label: "Research Exploration"
search_phrase: "Bayesian optimization on graphs"
positioning_note: "I am investigating graph-based Bayesian optimization and combinatorial search, documenting the search-space design and modeling direction rather than presenting a production tutorial."
---
...
![Combinatorial blow-up chart showing why brute-force seed selection is impossible for a 223,833-node graph at k=20.](/assets/blog/graphbo_combinatorial.png)
...
![trust_region](/assets/blog/trust_reg.png)
...
![bo_end_insight](/assets/blog/insi_end_bo.png)
...
![High-degree Higgs retweet subgraph showing top-degree seeds clustered in the hub region and diverse-subset seeds spread across the graph.](/assets/blog/graphbo_acquisition_landscape.png)
