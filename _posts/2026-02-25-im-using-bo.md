...
description: "A Bayesian optimization influence maximization study on the Higgs Twitter graph, showing how search-space design can turn the same optimizer from a 48% loss into a 4.5% gain."
...
permalink: /blog/influence-maximization-bayesian-optimization-higgs/
canonical_url: "https://app.chinmayarora.com/blog/influence-maximization-bayesian-optimization-higgs/"
og_image: "/assets/images/og-higgs-bayesian-optimization.png"
image_alt: "Bayesian optimization search paths across the Higgs Twitter retweet graph."
...
> **BLUF:** On the Higgs retweet graph, Bayesian optimization did not win because it was inherently smarter than a degree heuristic. Search-space design determined the result: an unconstrained representation lost by 48%, while a constrained diverse-subset search gained 4.5%.
>
> **Key takeaways**
> - Top-degree was a difficult baseline because influence on this graph is highly concentrated.
> - Reweighting centrality mostly rediscovered the degree heuristic.
> - An unconstrained 120-dimensional node search failed under the available evaluation budget.
> - Constraining diversity to influential candidates produced the strongest result.
> - The negative result is the useful one: more freedom can make optimization substantially worse.
...
- [SNAP Higgs Twitter dataset](https://snap.stanford.edu/data/higgs-twitter.html)
- Kempe, Kleinberg, and Tardos, [*Maximizing the Spread of Influence through a Social Network*](https://www.cs.cornell.edu/home/kleinber/kdd03-inf.pdf)
- Snoek, Larochelle, and Adams, [*Practical Bayesian Optimization of Machine Learning Algorithms*](https://arxiv.org/abs/1206.2944)
- [BOPIM: Bayesian Optimization for Influence Maximization on Temporal Networks](https://arxiv.org/abs/2308.04700)
- [Experiment code and data provenance](https://github.com/ChinmayA301/blog-artifacts)

## Related posts

- [Bayesian Optimization Meets Graphs](/blog/bo-graph/)
- [Engineering Virality with Bayesian Optimization](/blog/virality-bo/)
- [Financial Balance-Sheet RAG: evaluation for citation-grounded systems](/blog/financial-balance-sheet-rag/)
